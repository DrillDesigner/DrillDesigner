...
export interface Show {
  ...
  count: number; // this is the count, or position for all performers at a given time, that the show starts in. Defaults to 0. 'Show' object remembers what count to display
}
